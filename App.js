...
class App {
    constructor() {
        ...
        // this.type[0].addEventListener("click", 
        //     (e) => this.cross.style.visibility = 'visible');
        // this.type[1].addEventListener("click", 
        //     (e) => this.cross.style.visibility = 'hidden');
